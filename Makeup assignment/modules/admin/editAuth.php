...
if (isset($_GET['id'])) {
    ...
    // Retrieve user information based on the selected user ID
    $stmt = $DbConn->prepare("SELECT * FROM users WHERE userId = :userId");
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $updateStmt = $DbConn->prepare("UPDATE users SET Full_Name = :Full_Name, email = :email WHERE userId = :userId");
