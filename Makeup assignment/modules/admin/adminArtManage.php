...
if ($result) {
    if ($result->rowCount() > 0) {
        ...
        foreach ($result as $row) {
            ...
            // Edit button
            echo "<td><a href='editArticle.php?order=" . $row['article_order'] . "'>Edit</a></td>";

            // Delete button
            echo "<td><a href='../../processes/admin/deleteArticle.php?order=" . $row['article_order'] . "' onclick='return confirm(\"Are you sure you want to delete this article?\")'>Delete</a></td>";
